...
public class GrinderBlock extends BlockContainerRotating {

	public static final String registryName = "grinder";
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		player.openGui(HarvestCraft.instance, GuiHandler.GUIID_GRINDER, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}
