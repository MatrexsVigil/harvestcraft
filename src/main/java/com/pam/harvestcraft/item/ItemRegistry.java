...
public final class ItemRegistry {
	...
	private static void registerFoodItems() {
		...
		applepieItem = registerItemFood("applepieitem", 8, config.mealsaturation);
		...
		pumpkinsoupItem = registerItemFood("pumpkinsoupitem", 8, config.mealsaturation);
		melonsmoothieItem = registerPotionFood("melonsmoothieitem", 3, config.mealsaturation);

		carrotsoupItem = registerItemFood("carrotsoupitem", 8, config.mealsaturation);
		...
		loadedbakedpotatoItem = registerItemFood("loadedbakedpotatoitem", 11, config.mealsaturation);
		mashedpotatoesItem = registerItemFood("mashedpotatoesitem", 9, config.mealsaturation);
		potatosaladItem = registerItemFood("potatosaladitem", 7, config.mealsaturation);
		potatosoupItem = registerItemFood("potatosoupitem", 6, config.mealsaturation);
		friesItem = registerItemFood("friesitem", 4, config.mealsaturation);
		grilledmushroomItem = registerItemFood("grilledmushroomitem", 2, config.mealsaturation);
		stuffedmushroomItem = registerItemFood("stuffedmushroomitem", 6, config.mealsaturation);
		chickensandwichItem = registerItemFood("chickensandwichitem", 9, config.mealsaturation);
		chickennoodlesoupItem = registerItemFood("chickennoodlesoupitem", 9, config.mealsaturation);
		chickenpotpieItem = registerItemFood("chickenpotpieitem", 10, config.mealsaturation);
		breadedporkchopItem = registerItemFood("breadedporkchopitem", 5, config.mealsaturation);
		hotdogItem = registerItemFood("hotdogitem", 8, config.mealsaturation);
		bakedhamItem = registerItemFood("bakedhamitem", 9, config.mealsaturation);
		...
		baconcheeseburgerItem = registerItemFood("baconcheeseburgeritem", 14, config.mealsaturation);
		potroastItem = registerItemFood("potroastitem", 10, config.mealsaturation);
		...
		fishandchipsItem = registerItemFood("fishandchipsitem", 9, config.mealsaturation);
		...
		eggsaladItem = registerItemFood("eggsaladitem", 8, config.mealsaturation);
		caramelItem = registerItemFood("caramelitem", 2, config.mealsaturation);
		taffyItem = registerItemFood("taffyitem", 4, config.mealsaturation);
		spidereyesoupItem = registerItemFood("spidereyesoupitem", 8, config.mealsaturation);
		zombiejerkyItem = registerItemFood("zombiejerkyitem", 4, config.mealsaturation);
		cocoapowderItem = registerGenericItem("cocoapowderitem");
		chocolatebarItem = registerItemFood("chocolatebaritem", 5, config.mealsaturation);
		...
		vegetablesoupItem = registerItemFood("vegetablesoupitem", 8, config.mealsaturation);
		stockItem = registerItemFood("stockitem", 3, config.mealsaturation);
		fruitsaladItem = registerItemFood("fruitsaladitem", 6, config.mealsaturation);
		spagettiItem = registerItemFood("spagettiitem", 8, config.mealsaturation);
		spagettiandmeatballsItem = registerItemFood("spagettiandmeatballsitem", 11, config.mealsaturation);
		tomatosoupItem = registerItemFood("tomatosoupitem", 6, config.mealsaturation);
		ketchupItem = registerGenericItem("ketchupitem");
		chickenparmasanItem = registerItemFood("chickenparmasanitem", 8, config.mealsaturation);
		pizzaItem = registerItemFood("pizzaitem", 10, config.mealsaturation);
		springsaladItem = registerItemFood("springsaladitem", 9, config.mealsaturation);
		porklettucewrapItem = registerItemFood("porklettucewrapitem", 8, config.mealsaturation);
		fishlettucewrapItem = registerItemFood("fishlettucewrapitem", 6, config.mealsaturation);
		bltItem = registerItemFood("bltitem", 12, config.mealsaturation);
		leafychickensandwichItem = registerItemFood("leafychickensandwichitem", 11, config.mealsaturation);
		leafyfishsandwichItem = registerItemFood("leafyfishsandwichitem", 9, config.mealsaturation);
		deluxecheeseburgerItem = registerItemFood("deluxecheeseburgeritem", 12, config.mealsaturation);
		delightedmealItem = registerItemFood("delightedmealitem", 18, config.mealsaturation);
		...
		heartybreakfastItem = registerItemFood("heartybreakfastitem", 18, config.mealsaturation);
		...
		tacoItem = registerItemFood("tacoitem", 11, config.mealsaturation);
		fishtacoItem = registerItemFood("fishtacoitem", 9, config.mealsaturation);
		...
		peanutbuttercookiesItem = registerItemFood("peanutbuttercookiesitem", 9, config.mealsaturation);
		...
		raisincookiesItem = registerItemFood("raisincookiesitem", 9, config.mealsaturation);
		...
		bakedbeansItem = registerItemFood("bakedbeansitem", 10, config.mealsaturation);
		beansandriceItem = registerItemFood("beansandriceitem", 11, config.mealsaturation);
		chiliItem = registerItemFood("chiliitem", 13, config.mealsaturation);
		...
		supremepizzaItem = registerItemFood("supremepizzaitem", 13, config.mealsaturation);
		omeletItem = registerItemFood("omeletitem", 7, config.mealsaturation);
		hotwingsItem = registerItemFood("hotwingsitem", 10, config.mealsaturation);
		chilipoppersItem = registerItemFood("chilipoppersitem", 7, config.mealsaturation);
		extremechiliItem = registerItemFood("extremechiliitem", 14, config.mealsaturation);
		chilichocolateItem = registerItemFood("chilichocolateitem", 6, config.mealsaturation);
		...
		fishdinnerItem = registerItemFood("fishdinneritem", 8, config.mealsaturation);
		...
		candiedlemonItem = registerItemFood("candiedlemonitem", 4, config.mealsaturation);
		lemonchickenItem = registerItemFood("lemonchickenitem", 9, config.mealsaturation);
		...
		chocolatecherryItem = registerItemFood("chocolatecherryitem", 8, config.mealsaturation);
		...
		raspberryicedteaItem = registerPotionFood("raspberryicedteaitem", 7, config.mealsaturation);
		chaiteaItem = registerPotionFood("chaiteaitem", 9, config.mealsaturation);
		espressoItem = registerPotionFood("espressoitem", 8, config.mealsaturation);
		coffeeconlecheItem = registerPotionFood("coffeeconlecheitem", 10, config.mealsaturation);
		mochaicecreamItem = registerItemFood("mochaicecreamitem", 10, config.mealsaturation);
		...
		candiedsweetpotatoesItem = registerItemFood("candiedsweetpotatoesitem", 7, config.mealsaturation);
		...
		splitpeasoupItem = registerItemFood("splitpeasoupitem", 12, config.mealsaturation);

		pineapplehamItem = registerItemFood("pineapplehamitem", 10, config.mealsaturation);
		...
		gingersnapsItem = registerItemFood("gingersnapsitem", 8, config.mealsaturation);
		candiedgingerItem = registerItemFood("candiedgingeritem", 6, config.mealsaturation);
		mustardItem = registerGenericItem("mustarditem");
		softpretzelandmustardItem = registerItemFood("softpretzelandmustarditem", 10, config.mealsaturation);
		spicymustardporkItem = registerItemFood("spicymustardporkitem", 10, config.mealsaturation);
		...
		garlicchickenItem = registerItemFood("garlicchickenitem", 12, config.mealsaturation);
		...
		chickencelerycasseroleItem = registerItemFood("chickencelerycasseroleitem", 12, config.mealsaturation);
		...
		zestyzucchiniItem = registerItemFood("zestyzucchiniitem", 12, config.mealsaturation);
		zucchinibakeItem = registerItemFood("zucchinibakeitem", 12, config.mealsaturation);
		asparagusquicheItem = registerItemFood("asparagusquicheitem", 8, config.mealsaturation);
		...
		brownieItem = registerItemFood("brownieitem", 10, config.mealsaturation);
		...
		avocadoburritoItem = registerItemFood("avocadoburritoitem", 14, config.mealsaturation);
		...
		chickencurryItem = registerItemFood("chickencurryitem", 14, config.mealsaturation);
		coconutshrimpItem = registerItemFood("coconutshrimpitem", 10, config.mealsaturation);
		coconutyogurtItem = registerItemFood("coconutyogurtitem", 8, config.mealsaturation);
		orangechickenItem = registerItemFood("orangechickenitem", 12, config.mealsaturation);
		...
		cinnamonrollItem = registerItemFood("cinnamonrollitem", 8, config.mealsaturation);
		frenchtoastItem = registerItemFood("frenchtoastitem", 10, config.mealsaturation);
		marshmellowsItem = registerItemFood("marshmellowsitem", 5, config.mealsaturation);
		donutItem = registerItemFood("donutitem", 6, config.mealsaturation);
		chocolatedonutItem = registerItemFood("chocolatedonutitem", 8, config.mealsaturation);
		powdereddonutItem = registerItemFood("powdereddonutitem", 7, config.mealsaturation);
		jellydonutItem = registerItemFood("jellydonutitem", 8, config.mealsaturation);
		frosteddonutItem = registerItemFood("frosteddonutitem", 9, config.mealsaturation);
		...
		softpretzelItem = registerItemFood("softpretzelitem", 8, config.mealsaturation);
		jellybeansItem = registerItemFood("jellybeansitem", 5, config.mealsaturation);
		biscuitItem = registerItemFood("biscuititem", 6, config.mealsaturation);
		creamcookieItem = registerItemFood("creamcookieitem", 7, config.mealsaturation);
		jaffaItem = registerItemFood("jaffaitem", 9, config.mealsaturation);
		friedchickenItem = registerItemFood("friedchickenitem", 11, config.mealsaturation);

		footlongItem = registerItemFood("footlongitem", 14, config.mealsaturation);
		...
		cinnamonsugardonutItem = registerItemFood("cinnamonsugardonutitem", 8, config.mealsaturation);
		...
		peppermintItem = registerItemFood("peppermintitem", 5, config.mealsaturation);
		...
		gummybearsItem = registerItemFood("gummybearsitem", 5, config.mealsaturation);
		baconmushroomburgerItem = registerItemFood("baconmushroomburgeritem", 16, config.mealsaturation);
		fruitpunchItem = registerPotionFood("fruitpunchitem", 6, config.mealsaturation);
		meatystewItem = registerItemFood("meatystewitem", 8, config.mealsaturation);
		...
		shepardspieItem = registerItemFood("shepardspieitem", 12, config.mealsaturation);
		...
		sushiItem = registerItemFood("sushiitem", 6, config.mealsaturation);
		...
		cherrysodaItem = registerPotionFood("cherrysodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		colasodaItem = registerPotionFood("colasodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		gingersodaItem = registerPotionFood("gingersodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		grapesodaItem = registerPotionFood("grapesodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		lemonlimesodaItem =
				registerPotionFood("lemonlimesodaitem", 3, config.mealsaturation).addDefaultSpeedPotionEffect();
		orangesodaItem = registerPotionFood("orangesodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		rootbeersodaItem =
				registerPotionFood("rootbeersodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		strawberrysodaItem =
				registerPotionFood("strawberrysodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		...
		gingerchickenItem = registerItemFood("gingerchickenitem", 12, config.mealsaturation);
		...
		lambbarleysoupItem = registerItemFood("lambbarleysoupitem", 10, config.mealsaturation);
		honeylemonlambItem = registerItemFood("honeylemonlambitem", 8, config.mealsaturation);
		pumpkinoatsconesItem = registerItemFood("pumpkinoatsconesitem", 6, config.mealsaturation);
		beefjerkyItem = registerItemFood("beefjerkyitem", 5, config.mealsaturation);
		ovenroastedcauliflowerItem = registerItemFood("ovenroastedcaulifloweritem", 10, config.mealsaturation);
		leekbaconsoupItem = registerItemFood("leekbaconsoupitem", 8, config.mealsaturation);
		...
		roastedchestnutItem = registerItemFood("roastedchestnutitem", 4, config.mealsaturation);
		...
		apricotglazedporkItem = registerItemFood("apricotglazedporkitem", 6, config.mealsaturation);
		...
		grapefruitsodaItem =
				registerPotionFood("grapefruitsodaitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		...
		pralinesItem = registerItemFood("pralinesitem", 6, config.mealsaturation);
		...
		baconwrappeddatesItem = registerItemFood("baconwrappeddatesitem", 12, config.mealsaturation);
		...
		maplesausageItem = registerItemFood("maplesausageitem", 1, config.mealsaturation);
		...
		maplecandiedbaconItem = registerItemFood("maplecandiedbaconitem", 6, config.mealsaturation);
		...
		sausageinbreadItem = registerItemFood("sausageinbreaditem", 18, config.mealsaturation);
		chocolatecaramelfudgeItem = registerItemFood("chocolatecaramelfudgeitem", 6, config.mealsaturation);
		lavendershortbreadItem = registerItemFood("lavendershortbreaditem", 7, config.mealsaturation);
		beefwellingtonItem = registerItemFood("beefwellingtonitem", 18, config.mealsaturation);
		epicbaconItem = registerItemFood("epicbaconitem", 18, config.mealsaturation);
		manjuuItem = registerItemFood("manjuuitem", 6, config.mealsaturation);
		chickengumboItem = registerItemFood("chickengumboitem", 16, config.mealsaturation);
		generaltsochickenItem = registerItemFood("generaltsochickenitem", 12, config.mealsaturation);
		californiarollItem = registerItemFood("californiarollitem", 7, config.mealsaturation);
		...
		honeycombchocolatebarItem = registerItemFood("honeycombchocolatebaritem", 8, config.mealsaturation);
		cherrycoconutchocolatebarItem = registerItemFood("cherrycoconutchocolatebaritem", 10, config.mealsaturation);
		fairybreadItem = registerItemFood("fairybreaditem", 5, config.mealsaturation);

		timtamItem = registerItemFood("timtamitem", 9, config.mealsaturation);
		meatpieItem = registerItemFood("meatpieitem", 14, config.mealsaturation);
		chikorollItem = registerItemFood("chikorollitem", 14, config.mealsaturation);
		damperItem = registerItemFood("damperitem", 7, config.mealsaturation);
		beetburgerItem = registerItemFood("beetburgeritem", 18, config.mealsaturation);
		...
		chaoscookieItem = registerItemFood("chaoscookieitem", 4, config.mealsaturation);
		chocolatebaconItem = registerItemFood("chocolatebaconitem", 10, config.mealsaturation);
		lambkebabItem = registerItemFood("lambkebabitem", 12, config.mealsaturation);
		nutellaItem = registerItemFood("nutellaitem", 7, config.mealsaturation);
		snickersbarItem = registerItemFood("snickersbaritem", 8, config.mealsaturation);
		...
		bangersandmashItem = registerItemFood("bangersandmashitem", 12, config.mealsaturation);
		batteredsausageItem = registerItemFood("batteredsausageitem", 10, config.mealsaturation);
		batterItem = registerGenericItem("batteritem");
		chorizoItem = registerItemFood("chorizoitem", 10, config.mealsaturation);
		coleslawItem = registerItemFood("coleslawitem", 7, config.mealsaturation);
		energydrinkItem =
				registerPotionFood("energydrinkitem", 2, config.mealsaturation).addDefaultSpeedPotionEffect();
		friedonionsItem = registerItemFood("friedonionsitem", 4, config.mealsaturation);
		meatfeastpizzaItem = registerItemFood("meatfeastpizzaitem", 18, config.mealsaturation);
		mincepieItem = registerItemFood("mincepieitem", 12, config.mealsaturation);
		onionhamburgerItem = registerItemFood("onionhamburgeritem", 10, config.mealsaturation);
		pepperoniItem = registerItemFood("pepperoniitem", 10, config.mealsaturation);
		pickledonionsItem = registerItemFood("pickledonionsitem", 7, config.mealsaturation);
		porksausageItem = registerItemFood("porksausageitem", 8, config.mealsaturation);
		...
		turkeyrawItem = registerItemFood("turkeyrawitem", 2, config.mealsaturation);
		turkeycookedItem = registerItemFood("turkeycookeditem", 5, config.mealsaturation);
		venisonrawItem = registerItemFood("venisonrawitem", 3, config.mealsaturation);
		venisoncookedItem = registerItemFood("venisoncookeditem", 8, config.mealsaturation);
		...
		coleslawburgerItem = registerItemFood("coleslawburgeritem", 12, config.mealsaturation);
		roastchickenItem = registerItemFood("roastchickenitem", 9, config.mealsaturation);
		roastpotatoesItem = registerItemFood("roastpotatoesitem", 6, config.mealsaturation);
		sundayroastItem = registerItemFood("sundayroastitem", 14, config.mealsaturation);
		bbqpulledporkItem = registerItemFood("bbqpulledporkitem", 12, config.mealsaturation);
		lambwithmintsauceItem = registerItemFood("lambwithmintsauceitem", 11, config.mealsaturation);
		steakandchipsItem = registerItemFood("steakandchipsitem", 12, config.mealsaturation);
		...
		cornishpastyItem = registerItemFood("cornishpastyitem", 12, config.mealsaturation);
		cottagepieItem = registerItemFood("cottagepieitem", 12, config.mealsaturation);
		croissantItem = registerItemFood("croissantitem", 7, config.mealsaturation);
		currypowderItem = registerGenericItem("currypowderitem");
		dimsumItem = registerItemFood("dimsumitem", 12, config.mealsaturation);
		...
		hamsweetpicklesandwichItem = registerItemFood("hamsweetpicklesandwichitem", 10, config.mealsaturation);
		...
		okracreoleItem = registerItemFood("okracreoleitem", 8, config.mealsaturation);
		pistachiobutterItem = registerItemFood("pistachiobutteritem", 5, config.mealsaturation);
		ploughmanslunchItem = registerItemFood("ploughmanslunchitem", 14, config.mealsaturation);
		porklomeinItem = registerItemFood("porklomeinitem", 14, config.mealsaturation);
		salmonpattiesItem = registerItemFood("salmonpattiesitem", 12, config.mealsaturation);
		sausageItem = registerItemFood("sausageitem", 6, config.mealsaturation);
		sausagerollItem = registerItemFood("sausagerollitem", 10, config.mealsaturation);
		sesameballItem = registerItemFood("sesameballitem", 6, config.mealsaturation);
		sesamesnapsItem = registerItemFood("sesamesnapsitem", 3, config.mealsaturation);
		shrimpokrahushpuppiesItem = registerItemFood("shrimpokrahushpuppiesitem", 10, config.mealsaturation);
		...
		vindalooItem = registerItemFood("vindalooitem", 10, config.mealsaturation);
		...
		tunapotatoItem = registerItemFood("tunapotatoitem", 10, config.mealsaturation);
		chocolaterollItem = registerItemFood("chocolaterollitem", 8, config.mealsaturation);
		jamrollItem = registerItemFood("jamrollitem", 8, config.mealsaturation);
		...
		deluxechickencurryItem = registerItemFood("deluxechickencurryitem", 18, config.mealsaturation);
		...
		marzipanItem = registerItemFood("marzipanitem", 2, config.mealsaturation);
		paneertikkamasalaItem = registerItemFood("paneertikkamasalaitem", 12, config.mealsaturation);
		peaandhamsoupItem = registerItemFood("peaandhamsoupitem", 8, config.mealsaturation);
		...
		toadintheholeItem = registerItemFood("toadintheholeitem", 10, config.mealsaturation);
		...
		chickenchowmeinItem = registerItemFood("chickenchowmeinitem", 10, config.mealsaturation);
		kungpaochickenItem = registerItemFood("kungpaochickenitem", 12, config.mealsaturation);
		hoisinsauceItem = registerGenericItem("hoisinsauceitem");
		fivespiceItem = registerGenericItem("fivespiceitem");
		charsiuItem = registerItemFood("charsiuitem", 12, config.mealsaturation);
		sweetandsoursauceItem = registerGenericItem("sweetandsoursauceitem");
		sweetandsourchickenItem = registerItemFood("sweetandsourchickenitem", 10, config.mealsaturation);
		baconandeggsItem = registerItemFood("baconandeggsitem", 10, config.mealsaturation);
		...
		creepercookieItem = registerItemFood("creepercookieitem", 4, config.mealsaturation);
		...
		honeyglazedhamItem = registerItemFood("honeyglazedhamitem", 10, config.mealsaturation);
		honeysoyribsItem = registerItemFood("honeysoyribsitem", 14, config.mealsaturation);

		
		anchovypepperonipizzaItem = registerItemFood("anchovypepperonipizzaitem", 14, config.mealsaturation);
		chocovoxelsItem = registerItemFood("chocovoxelsitem", 3, config.mealsaturation);
		...
		cornedbeefItem = registerItemFood("cornedbeefitem", 10, config.mealsaturation);
		cottoncandyItem = registerItemFood("cottoncandyitem", 4, config.mealsaturation);
		crackersItem = registerItemFood("crackersitem", 6, config.mealsaturation);
		creeperwingsItem = registerItemFood("creeperwingsitem", 12, config.mealsaturation);
		...
		homestylelunchItem = registerItemFood("homestylelunchitem", 14, config.mealsaturation);
		...
		lasagnaItem = registerItemFood("lasagnaitem", 8, config.mealsaturation);
		lemondrizzlecakeItem = registerItemFood("lemondrizzlecakeitem", 8, config.mealsaturation);
		meatloafItem = registerItemFood("meatloafitem", 12, config.mealsaturation);
		montecristosandwichItem = registerItemFood("montecristosandwichitem", 10, config.mealsaturation);
		mushroomlasagnaItem = registerItemFood("mushroomlasagnaitem", 10, config.mealsaturation);
		musselcookedItem = registerItemFood("musselcookeditem", 2, config.mealsaturation);
		netherwingsItem = registerItemFood("netherwingsitem", 14, config.mealsaturation);
		pizzasoupItem = registerItemFood("pizzasoupitem", 11, config.mealsaturation);
		...
		sardinesinhotsauceItem = registerItemFood("sardinesinhotsauceitem", 6, config.mealsaturation);
		teriyakichickenItem = registerItemFood("teriyakichickenitem", 10, config.mealsaturation);
		...
		cornedbeefbreakfastItem = registerItemFood("cornedbeefbreakfastItem", 18, config.mealsaturation);
		greeneggsandhamItem = registerItemFood("greeneggsandhamItem", 5, config.mealsaturation);
		spaghettidinnerItem = registerItemFood("spaghettidinnerItem", 20, config.mealsaturation);
		theatreboxItem = registerItemFood("theatreboxItem", 11, config.mealsaturation);
		cookiesandmilkItem = registerItemFood("cookiesandmilkItem", 6, config.mealsaturation);
		crackersandcheeseItem = registerItemFood("crackersandcheeseItem", 9, config.mealsaturation);
		chickendinnerItem = registerItemFood("chickendinnerItem", 13, config.mealsaturation);
		bbqplatterItem = registerItemFood("bbqplatterItem", 19, config.mealsaturation);
		weekendpicnicItem = registerItemFood("weekendpicnicItem", 24, config.mealsaturation);
		corndogItem = registerItemFood("corndogItem", 6, config.mealsaturation);
		chilidogItem = registerItemFood("chilidogItem", 23, config.mealsaturation);
		hamandcheesesandwichItem = registerItemFood("hamandcheesesandwichItem", 8, config.mealsaturation);
		tunafishsandwichItem = registerItemFood("tunafishsandwichItem", 15, config.mealsaturation);
		tunasaladItem = registerItemFood("tunasaladItem", 17, config.mealsaturation);
		...
		chimichangaItem = registerItemFood("chimichangaItem", 24, config.mealsaturation);
		clamchowderItem = registerItemFood("clamchowderItem", 10, config.mealsaturation);
		breakfastburritoItem = registerItemFood("breakfastburritoItem", 13, config.mealsaturation);
		buttercookieItem = registerItemFood("buttercookieItem", 8, config.mealsaturation);
		...
		bbqpotatochipsItem = registerItemFood("bbqpotatochipsItem", 12, config.mealsaturation);
		sourcreamandonionpotatochipsItem = registerItemFood("sourcreamandonionpotatochipsItem", 8, config.mealsaturation);
		cheddarandsourcreampotatochipsItem = registerItemFood("cheddarandsourcreampotatochipsItem", 9, config.mealsaturation);
		tortillachipsItem = registerItemFood("tortillachipsItem", 9, config.mealsaturation);
		chipsandsalsaItem = registerItemFood("chipsandsalsaItem", 13, config.mealsaturation);
		chipsanddipItem = registerItemFood("chipsanddipItem", 8, config.mealsaturation);
		cheezepuffsItem = registerItemFood("cheezepuffsItem", 6, config.mealsaturation);
		surfandturfItem = registerItemFood("surfandturfItem", 6, config.mealsaturation);
		...
		deviledeggItem = registerItemFood("deviledeggItem", 9, config.mealsaturation);
		mozzerellasticksItem = registerItemFood("mozzerellasticksItem", 8, config.mealsaturation);
		gumboItem = registerItemFood("gumboItem", 16, config.mealsaturation);
		jambalayaItem = registerItemFood("jambalayaItem", 17, config.mealsaturation);
		succotashItem = registerItemFood("succotashItem", 8, config.mealsaturation);
		eggsbenedictItem = registerItemFood("eggsbenedictItem", 13, config.mealsaturation);
		friedgreentomatoesItem = registerItemFood("friedgreentomatoesItem", 7, config.mealsaturation);
		chickenandwafflesItem = registerItemFood("chickenandwafflesItem", 12, config.mealsaturation);
		potatoesobrienItem = registerItemFood("potatoesobrienItem", 6, config.mealsaturation);
		tatertotsItem = registerItemFood("tatertotsItem", 4, config.mealsaturation);
		smoresItem = registerItemFood("smoresItem", 17, config.mealsaturation);
		thankfuldinnerItem = registerItemFood("thankfuldinnerItem", 30, config.mealsaturation);
		steakfajitaItem = registerItemFood("steakfajitaItem", 13, config.mealsaturation);
		ramenItem = registerItemFood("ramenItem", 8, config.mealsaturation);
		misosoupItem = registerItemFood("misosoupItem", 7, config.mealsaturation);
		onigiriItem = registerItemFood("onigiriItem", 4, config.mealsaturation);
		grilledcheesevegemitetoastItem = registerItemFood("grilledcheesevegemitetoastItem", 14, config.mealsaturation);
		monsterfrieddumplingsItem = registerItemFood("monsterfrieddumplingsItem", 8, config.mealsaturation);
		salisburysteakItem = registerItemFood("salisburysteakItem", 18, config.mealsaturation);
		crispyricepuffcerealItem = registerItemFood("crispyricepuffcerealItem", 2, config.mealsaturation);
		crispyricepuffbarsItem = registerItemFood("crispyricepuffbarsItem", 7, config.mealsaturation);
		babaganoushItem = registerItemFood("babaganoushItem", 7, config.mealsaturation);
		berryvinaigrettesaladItem = registerItemFood("berryvinaigrettesaladItem", 10, config.mealsaturation);
		tomatoherbchickenItem = registerItemFood("tomatoherbchickenItem", 5, config.mealsaturation);
		pastagardeniaItem = registerItemFood("pastagardeniaItem", 9, config.mealsaturation);
		fiestacornsaladItem = registerItemFood("fiestacornsaladItem", 8, config.mealsaturation);
		threebeansaladItem = registerItemFood("threebeansaladItem", 13, config.mealsaturation);
		sweetandsourmeatballsItem = registerItemFood("sweetandsourmeatballsItem", 13, config.mealsaturation);
		pepperjellyItem = registerItemFood("pepperjellyItem", 5, config.mealsaturation);
		pepperjellyandcrackersItem = registerItemFood("pepperjellyandcrackersItem", 12, config.mealsaturation);
		saltedcaramelItem = registerItemFood("saltedcaramelItem", 3, config.mealsaturation);
		spidereyepieItem = registerItemFood("spidereyepieItem", 6, config.mealsaturation);
		cheesyshrimpquinoaItem = registerItemFood("cheesyshrimpquinoaItem", 10, config.mealsaturation);
		bulgogiItem = registerItemFood("bulgogiItem", 10, config.mealsaturation);
		omuriceItem = registerItemFood("omuriceItem", 8, config.mealsaturation);
		koreandinnerItem = registerItemFood("koreandinnerItem", 30, config.mealsaturation);
		...
		crabkimbapItem = registerItemFood("crabkimbapItem", 7, config.mealsaturation);
		froglegstirfryItem = registerItemFood("froglegstirfryItem", 7, config.mealsaturation);
		crawfishetoufeeItem = registerItemFood("crawfishetoufeeItem", 11, config.mealsaturation);
		haggisItem = registerItemFood("haggisItem", 9, config.mealsaturation);
		chickenkatsuItem = registerItemFood("chickenkatsuItem", 6, config.mealsaturation);
		chocolateorangeItem = registerItemFood("chocolateorangeItem", 7, config.mealsaturation);
		festivalbreadItem = registerItemFood("festivalbreadItem", 6, config.mealsaturation);
		fruitcreamfestivalbreadItem = registerItemFood("fruitcreamfestivalbreadItem", 10, config.mealsaturation);
		phoItem = registerItemFood("phoItem", 10, config.mealsaturation);
		bubbleteaItem = registerItemFood("bubbleteaItem", 5, config.mealsaturation);
		duckrawItem = registerItemFood("duckrawItem", 1, config.mealsaturation);
		duckcookedItem = registerItemFood("duckcookedItem", 1, config.mealsaturation);
		wontonsoupItem = registerItemFood("wontonsoupItem", 10, config.mealsaturation);
		springrollItem = registerItemFood("springrollItem", 9, config.mealsaturation);
		meatystirfryItem = registerItemFood("meatystirfryItem", 7, config.mealsaturation);
		potstickersItem = registerItemFood("potstickersItem", 10, config.mealsaturation);
		orangeduckItem = registerItemFood("orangeduckItem", 8, config.mealsaturation);
		pekingduckItem = registerItemFood("pekingduckItem", 8, config.mealsaturation);
		stuffedduckItem = registerItemFood("stuffedduckItem", 8, config.mealsaturation);
		...
		pumpkincheesecakeItem = registerItemPamCakeFood("pumpkincheesecakeitem", 12, config.mealsaturation,
		...
		cherrycheesecakeItem = registerItemPamCakeFood("cherrycheesecakeitem", 12, config.mealsaturation,
				BlockRegistry.cherrycheesecake);
		pineappleupsidedowncakeItem = registerItemPamCakeFood("pineappleupsidedowncakeitem", 10, config.mealsaturation,
		...
		redvelvetcakeItem =
				registerItemPamCakeFood("redvelvetcakeitem", 8, config.mealsaturation, BlockRegistry.redvelvetcake);
    ...
    public void onItemRegistry(RegistryEvent.Register<Item> e) {
        ...
        reg.register(BlockRegistry.candledeco3ItemBlock);
        reg.register(BlockRegistry.candledeco4ItemBlock);
        reg.register(BlockRegistry.candledeco5ItemBlock);
        reg.register(BlockRegistry.candledeco6ItemBlock);
        reg.register(BlockRegistry.candledeco7ItemBlock);
        reg.register(BlockRegistry.candledeco8ItemBlock);
        reg.register(BlockRegistry.candledeco9ItemBlock);
        reg.register(BlockRegistry.candledeco10ItemBlock);
        reg.register(BlockRegistry.candledeco11ItemBlock);
        reg.register(BlockRegistry.candledeco12ItemBlock);
        reg.register(BlockRegistry.candledeco13ItemBlock);
        reg.register(BlockRegistry.candledeco14ItemBlock);
        reg.register(BlockRegistry.candledeco15ItemBlock);
        reg.register(BlockRegistry.candledeco16ItemBlock);
        reg.register(BlockRegistry.carrotcakeItemBlock);
        reg.register(BlockRegistry.cheesecakeItemBlock);
        reg.register(BlockRegistry.cherrycheesecakeItemBlock);
        reg.register(BlockRegistry.chocolatesprinklecakeItemBlock);
        reg.register(BlockRegistry.trapItemBlock);
        reg.register(BlockRegistry.holidaycakeItemBlock);
        reg.register(BlockRegistry.honeycombItemBlock);
        reg.register(BlockRegistry.honeyItemBlock);
        reg.register(BlockRegistry.lamingtoncakeItemBlock);
        reg.register(BlockRegistry.marketItemBlock);
        reg.register(BlockRegistry.pavlovacakeItemBlock);
        reg.register(BlockRegistry.pineappleupsidedowncakeItemBlock);
        reg.register(BlockRegistry.pressedwaxItemBlock);
        reg.register(BlockRegistry.presserItemBlock);
        reg.register(BlockRegistry.pumpkincheesecakeItemBlock);
        reg.register(BlockRegistry.redvelvetcakeItemBlock);
